...
## Context
After provisioning, deploy results vanish from the SSE stream. Users cannot look up past deploy URLs, resource IDs, or timestamps. Strange's Done screen is ephemeral.
